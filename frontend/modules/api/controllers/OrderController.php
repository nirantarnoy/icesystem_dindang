...
//                    }
 ...
 //                   $model_trans->credit_qty = $list_product_data[$i]['line_credit_qty'];//$new_line_credit_qty;
                    ...
                    $model_trans->issue_transfer_qty = $this->getSaleOtherRouteQty($list_product_data[$i]['line_product_id'], $user_id, $login_date, date('Y-m-d H:i:s'), $company_id, $branch_id); //$list_product_data[$i]['line_transfer_qty'];// $this->getTransferout($value->product_id, $cal_date);
