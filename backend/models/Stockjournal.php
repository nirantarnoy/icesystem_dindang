...
//
//        $chk_reserv = \common\models\StockJournalReservNo::find()->where(['journal_no' => $prefix])->max('journal_no');
//        if ($chk_reserv) {
//            $cnum = substr((string)$chk_reserv->journal_no, $seq_len, strlen($chk_reserv->journal_no));
//            $len = strlen($cnum);
//            $clen = strlen($cnum + 1);
//            $loop = $len - $clen;
//            for ($i = 1; $i <= $loop; $i++) {
